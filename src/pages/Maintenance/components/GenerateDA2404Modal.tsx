...
export const GenerateDA2404Modal: React.FC<GenerateDA2404ModalProps> = ({
  ...
  const handleChange = (field: keyof DA2404FormData, value: any) => {
    setFormData((prev) => ({
      ...prev,
      [field]: value,
    }));
    ...
    >
      <DialogTitle>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          <FileText size={24} />
          <Typography variant="h6">Generate DA Form 2404</Typography>
        </Box>
      </DialogTitle>
      ...
      <DialogActions>
        ...
        <Button
          ...
          disabled={!formData.organizationName || !formData.nomenclature}
        >
          Generate DA 2404
        </Button>
      </DialogActions>
