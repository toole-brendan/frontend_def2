...
const mockReports: ReportData[] = [
  {
    ...
    description: 'Monthly summary of inventory status and changes',
    ...
    lastGenerated: '2024-04-15T10:00:00Z',
    format: 'PDF',
    status: 'approved',
  ...
  },
  {
    ...
    description: 'Weekly summary of transfer activities',
    ...
    lastGenerated: '2024-04-14T10:00:00Z',
    format: 'CSV',
    status: 'pending',
                    ...
                    <TableBody>
                      {mockReports.map((report) => (
                        <TableRow key={report.id}>
                          ...
                          <TableCell>
                            {report.type === 'inventory' ? 'Monthly' : report.type === 'transfers' ? 'Weekly' : 'Custom'}
                          </TableCell>
